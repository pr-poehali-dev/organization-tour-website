  ...
  return (
    <div className="min-h-screen bg-background font-open-sans">
      ...
      <section id="tours" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Наши Туры</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {tours.map((tour) => (
              <Card key={tour.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <CardHeader>
                  <CardTitle className="font-montserrat">{tour.title}</CardTitle>
      ...
      <section id="gallery" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Галерея</h2>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Отзывы</h2>
            <p className="text-xl text-muted-foreground">
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="text-center">
                <CardContent className="pt-6">
                  ...
                  <p className="font-semibold font-montserrat">{testimonial.name}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section id="blog" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Блог</h2>
            <p className="text-xl text-muted-foreground">
            ...
            {blogPosts.map((post, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardTitle className="font-montserrat text-lg">{post.title}</CardTitle>
      ...
      <section id="faq" className="py-20 bg-muted/50">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Часто задаваемые вопросы</h2>
            <p className="text-xl text-muted-foreground">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqItems.map((item, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="bg-white rounded-lg px-6">
                <AccordionTrigger className="font-montserrat text-left">
                  {item.question}
                </AccordionTrigger>
      ...
      <section id="contacts" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold font-montserrat mb-4">Контакты</h2>
            <p className="text-xl text-muted-foreground">
